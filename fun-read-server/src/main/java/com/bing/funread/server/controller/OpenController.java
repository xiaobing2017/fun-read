...
public class OpenController {
    ...
    @RequestMapping(value = "/getReadInfo/{courseId}/{poetryId}/{shareCode}", method = RequestMethod.GET)
    @ApiOperation(value = "查询用户课程诗词跟读信息", httpMethod = "GET", notes = "查询用户课程诗词跟读信息")
    public Result<List<ReadInfoVo>> getReadInfoByShareCode(@ApiParam(required = true, name = "courseId", value = "课程ID")
